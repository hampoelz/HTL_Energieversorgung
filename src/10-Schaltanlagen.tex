...
\GrayBox{Als **Schaltanlage** wird die Gesamtheit der Betriebsmittel (eines Ortes) bezeichnet, mit denen der **Strom** **verteilt**, **gemessen* oder **geschalten** wird - sowie die dazugehörigen **Schutz- und Steuereinrichtungen**. Ist ein **Transformator** vorhanden, spricht man von einer **Umspannanlage**.}
...
\GrayBox{Schaltgeräte sollen das Öffnen von Stromkreisen _(in denen ein großer Strom fließt)_ ermöglichen, und den Lichbogen löschen.}
...
\begin{minipage}[t]{0.3\textwidth}
    \begin{figure}[H]
        \centering
        \caption[Querkupplung]{\newline\centerline{\textbf{Querkupplung}}}
...
\begin{minipage}[t]{0.65\textwidth}
    \begin{minipage}[t]{0.45\textwidth}
        \begin{figure}[H]
            \centering
            \caption[Längskupplung]{\newline\centerline{\textbf{Längskupplung}}}
    ...
    \begin{minipage}[t]{0.55\textwidth}
        \begin{figure}[H]
            \centering
            \caption[Einfache Querkupplung]{\newline\centerline{\textbf{Einfache Querkupplung}}}
            \includegraphics[width=0.7\textwidth]{./images/10-Schaltanlagen/Querkupplung-Einfach.png}
        \end{figure}
    \end{minipage}
    \begin{figure}[H]
        \centering
        \caption[Umgehungsschiene mit einfacher Querkupplung]{\newline\centerline{\textbf{Umgehungsschiene mit einfacher Querkupplung}}}
        \includegraphics[width=0.7\linewidth]{./images/10-Schaltanlagen/Umgehungsschiene-mit-Querkupplung.png}
    \end{figure}
\end{minipage}
